...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const value: AuthCtx = {
    ...
    roles,
    loading,
    isMaster: roles.includes("master") || user?.email === "contatosbot01@gmail.com",
    isAdmin: roles.includes("master") || roles.includes("admin") || user?.email === "contatosbot01@gmail.com",
