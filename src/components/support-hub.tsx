...
export function SupportHub() {
  ...
  return (
    <div className="fixed right-4 z-[100] sm:right-6 bottom-[calc(env(safe-area-inset-bottom,0px)+1.5rem)] md:bottom-[calc(env(safe-area-inset-bottom,0px)+2rem)] transition-all duration-300">
