 ...
 */
export function getSEOMetadata(props) {
    const { title = DEFAULT_TITLE, description = DEFAULT_DESC, canonical, ogTitle, ogDescription, ogImage = DEFAULT_IMAGE, ogType = "website", twitterCard = "summary_large_image", noIndex = false, author, publishedTime, modifiedTime, section, keywords, } = props;
